...
public class GradebookControllerTest {
    ...
    @Test
    public void deleteAValidGradeHttpRequestStudentIdDoesNotExistEmptyResponde() throws Exception {

        Optional<HistoryGrade> historyGrade = historyGradeDao.findById(2);
