...
public class GradebookControllerTest {
    ...
    // ** BeforeAll needs to be static as per documentation, and any field used in it also needs to be static
    @BeforeAll
    ...
    @Test
    public void createANonValidGradeHttpRequesyGradeTypeDoesNotExistEmptyResponse() throws Exception {
